...
function addMcqOption(questionNumber) {
    ...
    $(    "<div class=\"margin-bottom-7px\" id=\"mcqOptionRow-"+curNumberOfChoiceCreated+idSuffix+"\">" +
...
function addMsqOption(questionNumber) {
    ...
    $(  "<div class=\"margin-bottom-7px\" id=\"msqOptionRow-"+curNumberOfChoiceCreated+idSuffix+"\">" +
            "<div class=\"input-group width-100-pc\">" +
                "<span class=\"input-group-addon\">" +
